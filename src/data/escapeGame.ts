...
export const ESCAPE_ZONES: EscapeZone[] = [
  ...
  // ===== NEW ZONE: Der Ärzterat (Interview Escape Game) =====
  {
    id: "aerzterat",
    name: "Der Arzterat",
    subtitle: "Le Conseil Medical — Preparation a l'entretien",
    icon: "⚕️",
    color: "indigo",
    description: "La salle du Conseil Medical — ou ta candidature est evaluee par les medecins seniors. Chaque salle est une etape de l'entretien d'embauche.",
    narrative: "Le Conseil Medical du Spitalzentrum Biel se reunit. Tu as ete convoquee pour une evaluation complete. Chaque epreuve teste une competence cle : presentation, motivation, raisonnement clinique, argumentation. Seuls les candidats qui reussissent toutes les epreuves recoivent le Sigil du Conseil.",
    unlockRequirement: { type: "zones_cleared", details: "Resous au moins 1 salle du Studio et 1 salle de l'Hopital", zoneIds: ["studio", "clinical"], count: 2 },
    rooms: [
      {
        id: "aerzterat-vorstellung",
        name: "Salle de Presentation",
        subtitle: "Stellen Sie sich vor",
        icon: "🎯",
        zoneId: "aerzterat",
        status: "locked",
        description: "La premiere epreuve — presente-toi de maniere structuree et professionnelle en allemand.",
        challenge: "Resous les puzzles de presentation : construis ton pitch medical",
        reward: { type: "vocal_seal", name: "Sceau de Presentation", icon: "🎯", description: "Tu sais te presenter en allemand medical" },
        unlockRequirement: { type: "none", details: "" },
        artifactTypes: ["interview_answer"],
        solveThreshold: 2,
        narrativeOnSolve: "Le Conseil accepte ton identification. Le panneau de presentation s'allume en vert. La salle Motivation s'ouvre...",
        narrativeOnDiscover: "La Salle de Presentation. Un pupitre, un micro, et les regards du Conseil. C'est ici que tout commence.",
      },
      {
        id: "aerzterat-motivation",
        name: "Salle de Motivation",
        subtitle: "Warum die Schweiz?",
        icon: "💡",
        zoneId: "aerzterat",
        status: "locked",
        description: "Justifie ta motivation pour travailler en Suisse. Structure, vocabulaire, et sincerite sont evalues.",
        challenge: "Resous le puzzle de motivation : pourquoi la Suisse ?",
        reward: { type: "vocal_seal", name: "Sceau de Motivation", icon: "💡", description: "Ta motivation est reconnue" },
        unlockRequirement: { type: "rooms_solved", details: "Resous la Salle de Presentation", roomIds: ["aerzterat-vorstellung"] },
        artifactTypes: ["interview_answer"],
        solveThreshold: 1,
        narrativeOnSolve: "Le Conseil hoche la tete. Ta motivation est sincere et structuree. La salle Erfahrung s'ouvre...",
        narrativeOnDiscover: "La salle de Motivation. Un grand ecran affiche la question fatidique : Warum?",
      },
      {
        id: "aerzterat-erfahrung",
        name: "Salle d'Experience",
        subtitle: "Berufserfahrung",
        icon: "📋",
        zoneId: "aerzterat",
        status: "locked",
        description: "Presente ton parcours professionnel de maniere chronologique et pertinente.",
        challenge: "Resous le puzzle de parcours : ordonne ta carriere",
        reward: { type: "vocal_seal", name: "Sceau d'Experience", icon: "📋", description: "Ton parcours est valide" },
        unlockRequirement: { type: "rooms_solved", details: "Resous la Salle de Motivation", roomIds: ["aerzterat-motivation"] },
        artifactTypes: ["interview_answer"],
        solveThreshold: 1,
        narrativeOnSolve: "Le chronometre du Conseil affiche ton parcours complet. Impressionnant. La salle d'Analyse s'active...",
        narrativeOnDiscover: "La salle d'Experience. Une timeline vide attend d'etre remplie avec ton parcours.",
      },
      {
        id: "aerzterat-fallanalyse",
        name: "Salle d'Analyse Clinique",
        subtitle: "Klinischer Fall",
        icon: "🔬",
        zoneId: "aerzterat",
        status: "locked",
        description: "Un cas clinique d'urgence. Prouve ton raisonnement medical en allemand.",
        challenge: "Resous les puzzles cliniques : diagnostic et raisonnement",
        reward: { type: "clinical_artifact", name: "Badge Clinique du Conseil", icon: "🔬", description: "Ton raisonnement clinique est prouve" },
        unlockRequirement: { type: "rooms_solved", details: "Resous la Salle d'Experience", roomIds: ["aerzterat-erfahrung"] },
        artifactTypes: ["diagnostic", "interview_answer"],
        solveThreshold: 2,
        narrativeOnSolve: "Diagnostic correct ! Le moniteur affiche 'VERIFIZIERT'. Le Conseil reconnait ton raisonnement. La salle d'Argumentation s'ouvre...",
        narrativeOnDiscover: "La salle d'Analyse Clinique. Des ecrans de monitoring, un dossier patient... le test clinique du Conseil.",
      },
      {
        id: "aerzterat-argumentation",
        name: "Salle d'Argumentation",
        subtitle: "Warum sollten wir Sie einstellen?",
        icon: "⚖️",
        zoneId: "aerzterat",
        status: "locked",
        description: "La question decisoire. Pourquoi toi ? Construis tes arguments.",
        challenge: "Resous le puzzle d'argumentation : convaincs le Conseil",
        reward: { type: "vocal_seal", name: "Sceau d'Argumentation", icon: "⚖️", description: "Tu sais argumenter en allemand" },
        unlockRequirement: { type: "rooms_solved", details: "Resous la Salle d'Analyse", roomIds: ["aerzterat-fallanalyse"] },
        artifactTypes: ["interview_answer"],
        solveThreshold: 1,
        narrativeOnSolve: "Le Conseil delibere... et approuve. Tu as convaincu. La salle finale t'attend...",
        narrativeOnDiscover: "La salle d'Argumentation. Le Conseil attend tes arguments. C'est ici que tu dois convaincre.",
      },
      {
        id: "aerzterat-finale",
        name: "Le Grand Entretien",
        subtitle: "Maitrise la salle du Conseil",
        icon: "👨‍⚕️",
        zoneId: "aerzterat",
        status: "locked",
        description: "L'entretien final avec le Chefarzt. Pas d'aide, pas d'indice. Prouve que tu es prete.",
        challenge: "Resous le puzzle final : l'entretien complet sans aide",
        reward: { type: "master_sigil", name: "Sigil du Conseil", icon: "🏅", description: "Le septieme Sigil — le Conseil Medical t'accepte comme Assistenzarztin" },
        unlockRequirement: { type: "rooms_solved", details: "Resous la Salle d'Argumentation", roomIds: ["aerzterat-argumentation"] },
        artifactTypes: ["interview_answer"],
        solveThreshold: 3,
        narrativeOnSolve: "Le Chefarzt se leve et te serre la main. 'Willkommen im Team.' Le Sigil du Conseil brille — tu es acceptee au Gefasszentrum.",
        narrativeOnDiscover: "La salle du Grand Entretien. Le Chefarzt est assis derriere son bureau. C'est le moment de verite.",
      },
    ],
  },
];
...
export const CHAPTERS: MissionChapter[] = [
  ...
  {
    id: "ch5",
    name: "Chapitre 5 : Der Arzterat",
    description: "Affronte le Conseil Medical — l'entretien final",
    icon: "📖",
    zones: ["aerzterat"],
    narrativeIntro: "Le Conseil Medical du Spitalzentrum Biel se reunit. Tu es convoquee pour une evaluation complete : presentation, motivation, cas clinique, argumentation. Prouve que tu es prete.",
    narrativeComplete: "Le Conseil t'a acceptee. Le Sigil du Conseil est forge. Il ne reste plus qu'a activer le Protocole Lazarus...",
    unlockRequirement: { type: "chapters_complete", chapterIds: ["ch3"] },
  },
  {
    id: "ch6",
    name: "Chapitre 6 : Protocole Lazarus",
    description: "Le denouement — rassemble les 7 Sigils",
    icon: "📖",
    zones: ["archive"],
    narrativeIntro: "Le moment final approche. Les Archives Centrales contiennent le mecanisme du Protocole Lazarus. Rassemble les 7 Sigils de Maitrise pour l'activer et rouvrir definitivement le complexe.",
    narrativeComplete: "Le Protocole Lazarus est active. Le Complexe Medical de Biel est rouvert. Tu es reconnue comme Assistenzarztin du Gefasszentrum. Willkommen im Team.",
    unlockRequirement: { type: "chapters_complete", chapterIds: ["ch4", "ch5"] },
  },
];
...
export const ZONE_COLORS: Record<string, { bg: string; border: string; text: string; glow: string; accent: string; gradient: string }> = {
  ...
  indigo: { bg: "from-indigo-500/15 to-indigo-500/5", border: "border-indigo-500/25", text: "text-indigo-400", glow: "shadow-indigo-500/20", accent: "bg-indigo-500", gradient: "from-indigo-500/60 to-indigo-400/30" },
};
